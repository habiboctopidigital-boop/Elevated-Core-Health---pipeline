    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          ...
          <span className="max-w-[88px] truncate">{patient.assignedUser?.name ?? "Assign"}</span>
...
export function PatientCard({ patient, onMoveStage, onClick, isDragging, onDragStart, onDragEnd }: PatientCardProps) {
  ...
  return (
    <div
      ...
      onDragEnd={onDragEnd}
      className={cn(
        "relative bg-white rounded-3xl border p-5 transition-all duration-150 overflow-hidden",
    ...
    >
      ...
      {/* - Info boxes: appointment + assigned user - */}
      <div className="grid grid-cols-2 gap-2.5 mb-2.5">
        {patient.appointmentDatetime && (
          <div className="flex items-center gap-2.5 rounded-2xl bg-[#F3FAF4] px-3.5 py-3 min-w-0">
        ...
        {patient.assignedUser ? (
          ...
          <div className="flex items-center justify-between gap-2 rounded-2xl bg-gradient-to-r from-amber-50 to-amber-50/60 px-3.5 py-3 min-w-0">
 ...
 {/* {patient.phone && (
      ...
      {/* - Checklist progress - */}
      {totalCount > 0 ? (
        <div className="mb-2.5 rounded-2xl bg-[#F3FAF4] px-3.5 py-3">
        ...
        <div className="flex items-center gap-2.5 rounded-2xl bg-blue-50/60 px-3.5 py-3 mb-2.5">
