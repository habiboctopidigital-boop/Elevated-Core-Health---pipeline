    ...
    >
      <PopoverTrigger asChild>
        <button
          type="button"
          className={cn(
            "flex items-center gap-1.5 h-10 px-3 rounded-xl border text-xs font-semibold whitespace-nowrap transition-all cursor-pointer",
            pending
      ...
      <PopoverContent className="w-[290px] p-3 rounded-2xl shadow-lg" align="start">
        ...
        {/* Presets + clear */}
        <div className="mt-3 pt-2 border-t border-[#EDEFF2] flex items-center justify-between gap-2">
