...
>(({ className, children, ...props }, ref) => (
  ...
  >
    {children}
    {/* Chevron rotates 180° while the list is open (data-state on the trigger). */}
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        "relative z-[130] max-h-96 min-w-[8rem] overflow-hidden rounded-md border bg-popover text-popover-foreground shadow-md",
